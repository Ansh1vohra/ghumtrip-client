...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`bg-white shadow-sm py-4 px-6 sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className='p-6'>
          ...
          <nav className='mt-12 flex flex-col space-y-4'>
            ...
            >
              <button
                onClick={openLogin}
                className='bg-transparent cursor-pointer hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded w-full'
              >
                Log In
              </button>
            </div>
